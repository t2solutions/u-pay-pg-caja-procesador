...
@JsonPropertyOrder({ "Institution", "InstitutionDesc", "Branch", "BranchDesc", "ClientCategory", 
	"ClientCategoryDesc", "ClientType", "ClientTypeDesc", "ReportType", "Role",
	"Client", "ClientDesc", "ID", "EnablesItem", 
	"AddInfo01", "AddInfo02", "AddInfo03", "AddInfo04", "BehaviourGroup", "BehaviourType", "ClientFullName" })
public class AddData implements Serializable {
	...
	public void setClientCategory(String cliCategory) {
		this.clientCategory = cliCategory;
	}
	...
	public void setClientCategoryDesc(String cliCategoryDesc) {
		this.clientCategoryDesc = cliCategoryDesc;
	}
