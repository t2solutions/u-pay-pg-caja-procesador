...
import com.upayments.pg.caja.api.io.soap.getkeysdukpt.DataInput;

@Component(value="getKeysDUKPTByPan")
public class GetKeysDUKPTByPanRoute extends RestRouteBuilder {

	@Override
	public void configure() throws Exception {
		
	    rest("/getKeysDUKPTByPan")
	    	.post("/")
	    	.description("Servicio para invocar a WS SOAP GetKeysDUKPTByPan")
	    	.type(DataInput.class)
	    	.outType(String.class)
	    	.consumes("application/json")
	    	.produces("text/plain")
	    	.to("direct:GetKeysDUKPTByPan");	
	    
	    from("direct:GetKeysDUKPTByPan")
	    	.handleFault()
		    .log("${body}")
		    ...
		    .unmarshal().json(JsonLibrary.Jackson, DataInput.class)
		    .to("velocity:GetKeysDUKPTByPan_Req.vm")
		    .log("HEADER IDA -> ${in.header.CamelSpringWebServiceSoapHeader}")
		    .log("BODY IDA -> ${body}")
		    .log("DESTINO: -> {{soap.remote.GetKeysDUKPTByPan.ep}} ACCION: -> {{soap.remote.GetKeysDUKPTByPan.action}} ")
	    	.to("spring-ws:{{soap.remote.GetKeysDUKPTByPan.ep}}?soapAction={{soap.remote.GetKeysDUKPTByPan.action}}")
	    	...
	    	.to("xslt:GetKeysDUKPTByPan_Body_Rsp.xsl") //Por defecto, output es string
	    	.log("BODY VUELTA POST XSLT-> ${body}")  	
	    	
	    	.convertBodyTo(String.class)
	    	.to("xslt:GetKeysDUKPTByPan_Aux_Rsp.xsl")
