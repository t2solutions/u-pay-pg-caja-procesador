...
import com.upayments.pg.caja.api.io.soap.reissuecard.DataInput;

@Component(value="reissueCard")
public class ReissueCardRoute extends RestRouteBuilder {
	...
	public void configure() throws Exception {
	    ...
	    rest("/reissueCard")
	    	.post("/")
	    	.description("Servicio para invocar a WS SOAP ReissueCard")
	    	.type(DataInput.class)
	    	.outType(String.class)
	    	.consumes("application/json")
	    	.produces("text/plain")
	    	.to("direct:ReissueCard");	
	    
	    from("direct:ReissueCard")
	    	.handleFault()
		    .log("${body}")
		    ...
		    .unmarshal().json(JsonLibrary.Jackson, DataInput.class)
		    .to("velocity:ReissueCard_Req.vm")
		    .log("HEADER IDA -> ${in.header.CamelSpringWebServiceSoapHeader}")
		    .log("BODY IDA -> ${body}")
		    .log("DESTINO: -> {{soap.remote.ReissueCard.ep}} ACCION: -> {{soap.remote.ReissueCard.action}} ")
	    	.to("spring-ws:{{soap.remote.ReissueCard.ep}}?soapAction={{soap.remote.ReissueCard.action}}")
	    	...
	    	.to("xslt:ReissueCard_Body_Rsp.xsl") //Por defecto, output es string
	    	.log("BODY VUELTA POST XSLT-> ${body}")  	
	    	
	    	.convertBodyTo(String.class)
	    	.to("xslt:ReissueCard_Aux_Rsp.xsl")
