...
import com.upayments.pg.caja.api.io.soap.getcardpinoffset.DataInput;

@Component(value="getCardPinOffsetByPan")
public class GetCardPinOffsetByPanRoute extends RestRouteBuilder {

	@Override
	public void configure() throws Exception {
		
	    rest("/GetCardPinOffsetByPan")
	    	.post("/")
	    	.description("Servicio para invocar a WS SOAP GetCardPinOffsetByPan")
	    	.type(DataInput.class)
	    	.outType(String.class)
	    	.consumes("application/json")
	    	.produces("text/plain")
	    	.to("direct:GetCardPinOffsetByPan");	
	    
	    from("direct:GetCardPinOffsetByPan")
	    	.handleFault()
		    .log("${body}")
		    ...
		    .unmarshal().json(JsonLibrary.Jackson, DataInput.class)
		    .to("velocity:GetCardPINOffsetByPan_Req.vm")
		    .log("HEADER IDA -> ${in.header.CamelSpringWebServiceSoapHeader}")
		    .log("BODY IDA -> ${body}")
		    .log("DESTINO: -> {{soap.remote.GetCardPINOffsetByPan.ep}} ACCION: -> {{soap.remote.GetCardPINOffsetByPan.action}} ")
	    	.to("spring-ws:{{soap.remote.GetCardPINOffsetByPan.ep}}?soapAction={{soap.remote.GetCardPINOffsetByPan.action}}")
	    	...
	    	.to("xslt:GetCardPINOffsetByPan_Body_Rsp.xsl") //Por defecto, output es string
	    	.log("BODY VUELTA POST XSLT-> ${body}")  	
	    	
	    	.convertBodyTo(String.class)
	    	.to("xslt:GetCardPINOffsetByPan_Aux_Rsp.xsl")
