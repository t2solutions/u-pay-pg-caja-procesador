...
import com.upayments.pg.caja.api.io.soap.editclient.DataInput;

@Component(value="editClient")
public class EditClientRoute extends RestRouteBuilder {
	...
	public void configure() throws Exception {
	    ...
	    rest("/editClient")
	    	.post("/")
	    	.description("Servicio para invocar a WS SOAP EditClient")
	    	.type(DataInput.class)
	    	.outType(String.class)
	    	.consumes("application/json")
	    	.produces("text/plain")
	    	.to("direct:EditClient");	
	    
	    from("direct:EditClient")
	    	.handleFault()
		    .log("${body}")
		    ...
		    .unmarshal().json(JsonLibrary.Jackson, DataInput.class)
		    .to("velocity:EditClient_Req.vm")
		    .log("HEADER IDA -> ${in.header.CamelSpringWebServiceSoapHeader}")
		    .log("BODY IDA -> ${body}")
		    .log("DESTINO: -> {{soap.remote.EditClient.ep}} ACCION: -> {{soap.remote.EditClient.action}} ")
	    	.to("spring-ws:{{soap.remote.EditClient.ep}}?soapAction={{soap.remote.EditClient.action}}")
	    	...
	    	.to("xslt:EditClient_Body_Rsp.xsl") //Por defecto, output es string
	    	.log("BODY VUELTA POST XSLT-> ${body}")  	
	    	
	    	.convertBodyTo(String.class)
	    	.to("xslt:EditClient_Aux_Rsp.xsl")
