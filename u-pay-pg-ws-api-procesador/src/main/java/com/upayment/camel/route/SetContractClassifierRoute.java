...
import com.upayments.pg.caja.api.io.soap.setcontractclassifier.DataInput;

@Component(value="SetContractClassifierRoute")
public class SetContractClassifierRoute extends RestRouteBuilder {

	@Override
	public void configure() throws Exception {
		
	    rest("/setContractClassifier")
	    	.post("/")
	    	.description("Servicio para invocar a WS SOAP SetContractClassifier")
	    	.type(DataInput.class)
	    	.outType(String.class)
	    	.consumes("application/json")
	    	.produces("text/plain")
	    	.to("direct:SetContractClassifier");	
	    
	    from("direct:SetContractClassifier")
	    	.handleFault()	    	
		    ...
		    .unmarshal().json(JsonLibrary.Jackson, DataInput.class)
		    .to("velocity:SetContractClassifier_Req.vm")
		    .log("HEADER IDA -> ${in.header.CamelSpringWebServiceSoapHeader}")
		    .log("BODY IDA -> ${body}")
		    .log("DESTINO: -> {{soap.remote.SetContractClassifierOp.ep}} ACCION: -> {{soap.remote.SetContractClassifierOp.action}} ")
	    	.to("spring-ws:{{soap.remote.SetContractClassifierOp.ep}}?soapAction={{soap.remote.SetContractClassifierOp.action}}")
	    	...
	    	.to("xslt:SetContractClassifier_Body_Rsp.xsl") //Por defecto, output es string
	    	.log("BODY VUELTA POST XSLT-> ${body}")  	
	    	
	    	.convertBodyTo(String.class)
	    	.to("xslt:SetContractClassifier_Aux_Rsp.xsl")
