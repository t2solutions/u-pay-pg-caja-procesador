...
import com.upayments.pg.caja.api.io.soap.getcardbyrut.DataInput;

@Component(value="getCardByRutRoute")
public class GetCardByRutRoute extends RestRouteBuilder {
	...
	public void configure() throws Exception {
	    ...
	    rest("/getCardByRut")
	    	.post("/")
	    	.description("Servicio para invocar a WS SOAP GetCardByRut")
	    	.type(DataInput.class)
	    	.outType(String.class)
	    	.consumes("application/json")
	    	.produces("text/plain")
	    	.to("direct:GetCardByRut");	
	    
	    from("direct:GetCardByRut")
	    	.handleFault()	    	
		    ...
		    .unmarshal().json(JsonLibrary.Jackson, DataInput.class)
		    .to("velocity:GetCardByRut_Req.vm")
		    .log("HEADER IDA -> ${in.header.CamelSpringWebServiceSoapHeader}")
		    .log("BODY IDA -> ${body}")
		    .log("DESTINO: -> {{soap.remote.GetCardByRutOp.ep}} ACCION: -> {{soap.remote.GetCardByRutOp.action}} ")
	    	.to("spring-ws:{{soap.remote.GetCardByRutOp.ep}}?soapAction={{soap.remote.GetCardByRutOp.action}}")
	    	...
	    	.to("xslt:GetCardByRut_Body_Rsp.xsl") //Por defecto, output es string
	    	.log("BODY VUELTA POST XSLT-> ${body}")  	
	    	
	    	.convertBodyTo(String.class)
	    	.to("xslt:GetCardByRut_Aux_Rsp.xsl")
